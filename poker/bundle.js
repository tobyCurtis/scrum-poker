...
var app = (function () {
    ...
    /* src/components/Card.svelte generated by Svelte v3.46.6 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			t2 = text(/*name*/ ctx[1]);
    			add_location(div0, file$3, 8, 8, 186);
    			attr_dev(div1, "class", div1_class_value = "card " + (/*hasSelection*/ ctx[2] ? 'selected' : '') + " svelte-l8fd0h");
    			add_location(div1, file$3, 7, 1, 126);
    			add_location(div2, file$3, 10, 1, 216);
    			attr_dev(div3, "class", "user-card-container svelte-l8fd0h");
    			add_location(div3, file$3, 6, 0, 91);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*hasSelection*/ 4 && div1_class_value !== (div1_class_value = "card " + (/*hasSelection*/ ctx[2] ? 'selected' : '') + " svelte-l8fd0h")) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['text', 'name', 'hasSelection'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('hasSelection' in $$props) $$invalidate(2, hasSelection = $$props.hasSelection);
    	};

    	$$self.$capture_state = () => ({ text, name, hasSelection });
    	...
    	return [text, name, hasSelection];
    }

    class Card extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { text: 0, name: 1, hasSelection: 2 });
    		...
    		if (/*hasSelection*/ ctx[2] === undefined && !('hasSelection' in props)) {
    			console.warn("<Card> was created without expected prop 'hasSelection'");
    		}
    	}
    ...
    /* src/components/Choice.svelte generated by Svelte v3.46.6 */
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function emitPoints() {
    		dispatch('click', { points });
    	}

    	const writable_props = ['points', 'selected'];
    	...
    	return [points, selected, emitPoints];
    }

    class Choice extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { points: 0, selected: 1 });
    		...
    		if (/*points*/ ctx[0] === undefined && !('points' in props)) {
    			console.warn("<Choice> was created without expected prop 'points'");
    		}

    		if (/*selected*/ ctx[1] === undefined && !('selected' in props)) {
    			console.warn("<Choice> was created without expected prop 'selected'");
    		}
    	}
    ...
    // (55:2) {#each players as {user, points}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(55:2) {#each players as {user, points}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 63, 3, 1649);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*nextIssue*/ ctx[9], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    // (61:2) {#if players.find(player => player.points) && !cardsFlipped}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 61, 3, 1572);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*cardFlip*/ ctx[8], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(61:2) {#if players.find(player => player.points) && !cardsFlipped}",
    		ctx
    	});
    ...
    // (69:2) {#each pointOptions as pointValue, i}
    function create_each_block(ctx) {
    	...
    	choice.$on("click", /*sendPoints*/ ctx[7]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(69:2) {#each pointOptions as pointValue, i}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(76:0) {#if showNameSelection}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 80, 2, 1997);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_header_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 77, 2, 1947);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 81, 2, 2055);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*joinTheTable*/ ctx[6], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_fragment(ctx) {
    	...
    	let current;
    	let each_value_1 = /*players*/ ctx[3];
    	...
    	function select_block_type(ctx, dirty) {
    		if (dirty & /*players, cardsFlipped*/ 24) show_if = null;
    		if (show_if == null) show_if = !!(/*players*/ ctx[3].find(func) && !/*cardsFlipped*/ ctx[4]);
    		if (show_if) return create_if_block_1;
    		if (/*cardsFlipped*/ ctx[4]) return create_if_block_2;
    	}

    	let current_block_type = select_block_type(ctx, -1);
    	let if_block0 = current_block_type && current_block_type(ctx);
    	let each_value = /*pointOptions*/ ctx[5];
    	...
    	let if_block1 = /*showNameSelection*/ ctx[0] && create_if_block(ctx);

    	const block = {
    		c: function create() {
    			div3 = element("div");
    			h1 = element("h1");
    			h1.textContent = "Scrum Poker";
    			t1 = space();
    			div0 = element("div");
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*players, cardsFlipped*/ 24) {
    				each_value_1 = /*players*/ ctx[3];
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (dirty & /*pointOptions, mySelection, sendPoints*/ 164) {
    				each_value = /*pointOptions*/ ctx[5];
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (/*showNameSelection*/ ctx[0]) {
    				if (if_block1) {
    					if_block1.p(ctx, dirty);

    					if (dirty & /*showNameSelection*/ 1) {
    ...
    const func = player => player.points;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function joinTheTable() {
    		$$invalidate(0, showNameSelection = false);
    	...
    	function sendPoints(event) {
    		...
    		$$invalidate(2, mySelection = points);
    	...
    	ws.addEventListener('message', msg => {
    		...
    		if (message.type === 'playerUpdate') {
    			$$invalidate(3, players = message.players);
    		} else if (message.type === 'cardFlip') {
    			$$invalidate(4, cardsFlipped = true);
    		} else if (message.type === 'nextIssue') {
    			$$invalidate(2, mySelection = null);
    			$$invalidate(4, cardsFlipped = false);
    			$$invalidate(3, players = message.players);
    		}
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('name' in $$props) $$invalidate(1, name = $$props.name);
    		if ('pointOptions' in $$props) $$invalidate(5, pointOptions = $$props.pointOptions);
    		if ('mySelection' in $$props) $$invalidate(2, mySelection = $$props.mySelection);
    		if ('players' in $$props) $$invalidate(3, players = $$props.players);
    		if ('cardsFlipped' in $$props) $$invalidate(4, cardsFlipped = $$props.cardsFlipped);
    	};
